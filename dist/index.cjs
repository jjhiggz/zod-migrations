...
__export(src_exports, {
  ...
  createJsonEvolver: () => createJsonEvolver,
  mutators: () => mutators,
...
var rename = (source, destination) => {
  const up = (input) => {
    ...
    return (0, import_remeda.pipe)(input, (0, import_remeda.omit)([source]), (0, import_remeda.addProp)(destination, value));
  };
  return {
    up,
    tag: "rename",
...
var renameMany = ({
  ...
  return {
    ...
    beforeMutate: () => {
      if ((0, import_remeda.unique)(Object.values(rename)).length > Object.values(rename).length) {
